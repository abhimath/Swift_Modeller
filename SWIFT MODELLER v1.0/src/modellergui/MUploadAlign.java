...
public class MUploadAlign
{
    public MUploadAlign(StringBuffer templates, String title, Component c)
    {
        ...
        {
            new ErrorClose(c, true, "File Not Found : " + file1.getName());
        }
        catch (IOException e)
        {
        ...
        exectext1.append("mod" + version + " salign.py\n");
        exectext1.append("exit");
        new ExecuteScript(exectext1, outputfile1, c);

        new FlushScript(c);
        
        exectext2.append("mod" + version + " align2d_mult.py\n");
        exectext2.append("exit");
