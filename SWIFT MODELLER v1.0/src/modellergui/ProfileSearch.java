...
public class ProfileSearch extends javax.swing.JFrame {
    ...
    public ProfileSearch() {
        ...
        workpath = ModellerGUIView.workpath;
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(modellergui.ModellerGUIApp.class).getContext().getResourceMap(ProfileSearch.class);
    ...
    private void dwnldtmplt(String tmplts)
    {
        ...
        while(st.hasMoreTokens())
        {
            ...
            try
            {
                File file = new File(workpath + sep + filename);
                if(file.length() == 0)
                {
                    Thread.sleep(1000);
                }
    ...
    private void fileUrl(String fAddress, String localFileName, String destinationDir)
    {
        ...
        {
            new ErrorClose(this, true, "File Not Found : " + localFileName);
        }
        catch (IOException e)
        {
            new ErrorClose(this, true, "I/O Error");
    ...
    private void extracttmplt(String tmplt)
    {
        try
        {
            String inFilename = workpath + sep + tmplt;
            GZIPInputStream gzipInputStream = new GZIPInputStream(new FileInputStream(inFilename));
            String outFilename = workpath + sep + tmplt.substring(3, 7) + ".pdb";
        ...
        {
            new ErrorClose(this, true, "File Not Found : " + tmplt);
        }
        catch(IOException e)
        {
            new ErrorClose(this, true, "I/O Error");
