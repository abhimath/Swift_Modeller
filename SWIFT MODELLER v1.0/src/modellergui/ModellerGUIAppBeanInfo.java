 ...
 * @author WOLVERINE
 */
public class ModellerGUIAppBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( modellergui.ModellerGUIApp.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_context] = new PropertyDescriptor ( "context", modellergui.ModellerGUIApp.class, "getContext", null ); // NOI18N
            properties[PROPERTY_exitListeners] = new PropertyDescriptor ( "exitListeners", modellergui.ModellerGUIApp.class, "getExitListeners", null ); // NOI18N
            properties[PROPERTY_mainFrame] = new PropertyDescriptor ( "mainFrame", modellergui.ModellerGUIApp.class, "getMainFrame", null ); // NOI18N
            properties[PROPERTY_mainView] = new PropertyDescriptor ( "mainView", modellergui.ModellerGUIApp.class, "getMainView", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", modellergui.ModellerGUIApp.class, "getPropertyChangeListeners", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_exitListener] = new EventSetDescriptor ( modellergui.ModellerGUIApp.class, "exitListener", org.jdesktop.application.Application.ExitListener.class, new String[] {"canExit", "willExit"}, "addExitListener", "removeExitListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( modellergui.ModellerGUIApp.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_getApplication3] = new MethodDescriptor(modellergui.ModellerGUIApp.class.getMethod("getApplication", new Class[] {})); // NOI18N
            ...
            methods[METHOD_main8] = new MethodDescriptor(modellergui.ModellerGUIApp.class.getMethod("main", new Class[] {java.lang.String[].class})); // NOI18N
